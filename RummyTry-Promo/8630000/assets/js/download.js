...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function DownSoft() {
      ...
      if (fbclid && fbclid.length > 1) {
          // Channel APK this URL
          golink = "https://xjpklccossyd06.zxcvrfrec.com/Rummytry/RummyTry-8630000.apk";
      } else {
          golink = "https://xjpklccossyd06.zxcvrfrec.com/Rummytry/RummyTry-8630000.apk";
      }
      ...
      if (isiOS) {
          ...
          window.location.href = "https://xjpklccossyd06.zxcvrfrec.com/Rummytry/RummyTry-8630000.apk";
      } else if (isAndroid) {
          window.location.href = golink;
      } else {
          window.location.href = golink;
